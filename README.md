...
<p align="center">
  ...
  <a href="https://www.notion.so/Junior-Node-js-Developer-63e7b8c7c31543dc8eb119337b5f9423"><strong>My Resume</strong></a>
</p>
<br/>
...
<br/>
이 서비스는 미대를 졸업하고 지금도 취미로 그림을 그리는 제 친구의 작품이 작업실에 그냥 쌓여있는 것이 아깝다는 생각에서 시작되었습니다. <br/>
캔버스화는 미술관에서나 보는 범접할 수 없는 예술이라는 관념에서 벗어나, <br/>
보다 쉽게 접하고 하나쯤은 소유할 수 있는, 더불어 쉽게 판매할 수 있다는 취지를 가지고 프로젝트를 진행하였습니다. </p>
...
<h4> 따라서 본격적인 리팩토링 시작 전, 아래의 리스트를 작성했고 이 방향성을 따라 나아가고 있습니다. </h4>
...
기존에 작성한 MVC 디자인 패턴에서 관심사 분리를 스코프를 넓혀 레이어 별로 책임을 분명히 하고 <br/>
...
<br/>
관심사 분리를 위해서는 의존성 규칙 필요하고, 소프트웨어가 외부 인프라가 아닌 어플리케이션 중심의 설계가 될 수 있도록 <br/>
의존 흐름은 외부에서 내부로 흐르는 단 방향을 유지해야 합니다.  <br/>
